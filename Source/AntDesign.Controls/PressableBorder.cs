...
public class PressableBorder : Border
{
    ...
    public static readonly DirectProperty<PressableBorder, bool> IsPressedProperty =
           AvaloniaProperty.RegisterDirect<PressableBorder, bool>(nameof(IsPressed), b => b.IsPressed);
